...
public class InvalidInputDataException extends Exception {
	...
	public InvalidInputDataException(String message, File file, int lineNr,
			Exception cause) {
		super(message, cause);
		_file = file;
		_line = lineNr;
	...
	public InvalidInputDataException(String message, String filename, int lineNr,
			Exception cause) {
	...
	/**
	 * This methods returns the path of the file. The method name might be
	 * misleading.
	 * 

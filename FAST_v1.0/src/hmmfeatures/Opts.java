/**
 * This version doesn't have parameterizedTrans.
 * 
 * @param 
 *   -- bias: if use bias feature, should set it 1.0, otherwise -1.0; input file should not consist bias feature by itself, and should be added by this option.
 *   -- oneBiasFeature: if true, means ignore other features in the input file and add a bias feature by the code
 */

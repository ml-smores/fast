...
public class KMeansLearner<O extends Observation & CentroidFactory<? super O>> {
	...
	/**
	 * Initializes a K-Means algorithm implementation. This algorithm finds a HMM
	 * that models a set of observation sequences.
	 * 
	 * @param nbStates
	 ...
	 * @param sequences
	 *          A vector of observation sequences. Each observation sequences is a
	 *          vector of {@link be.ac.ulg.montefiore.run.jahmm.Observation
